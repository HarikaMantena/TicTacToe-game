...
class TicTacToe{
	...
	static void insertPosition(char board[][],int position,String playerType) {
		...
		case 9:board[4][4] = ch;
		break;
		default:System.out.println("Please select the position between(1-9)");
		break;
		}
	}
	...
	public static void winningCondition() {
		...
		if(player.containsAll(winningCondition.get(0))||player.containsAll(winningCondition.get(1))
				||player.containsAll(winningCondition.get(2))||player.containsAll(winningCondition.get(3))
				||player.containsAll(winningCondition.get(4))||player.containsAll(winningCondition.get(5))
				||player.containsAll(winningCondition.get(6))||player.containsAll(winningCondition.get(7))) {
			System.out.println("Player wins");
			System.exit(0);
		}
		else if(cpu.containsAll(winningCondition.get(0))||cpu.containsAll(winningCondition.get(1))
				||cpu.containsAll(winningCondition.get(2))||cpu.containsAll(winningCondition.get(3))
				||cpu.containsAll(winningCondition.get(4))||cpu.containsAll(winningCondition.get(5))
				||cpu.containsAll(winningCondition.get(6))||cpu.containsAll(winningCondition.get(7))) {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			while(TicTacToe.player.contains(playerPosition)||TicTacToe.cpu.contains(playerPosition) ) {
				System.out.println("Position not available.please select a new position");
